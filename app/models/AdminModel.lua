...
function _M.new()
  local o=M:new()o:set_table(_M._TABLE)setmetatable(o,{__index=_M})return o
end
...
function _M:list(o)
  ...
  if o.keyword and o.keyword~="" then
    local c={}for _,f in ipairs(sf)do local kw=(o.keyword or ""):gsub("'", "\\'") c[#c+1]="admin."..f.." LIKE \"%%"..kw.."%%\"" end
