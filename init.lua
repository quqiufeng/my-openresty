package.path = '/var/www/web/my-openresty/app/?.lua;/var/www/web/my-openresty/app/core/?.lua;/var/www/web/my-openresty/app/lib/?.lua;/var/www/web/my-openresty/app/middleware/?.lua;;'
