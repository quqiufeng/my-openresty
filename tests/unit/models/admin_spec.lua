-- AdminModel Unit Tests
-- Generated by curd command. Run with: luajit tests/unit/models/admin_spec.lua
...
print("=============================================================")
print("AdminModel Unit Tests")
print("=============================================================")
print()

-- Test: new()
print("Test: new()")
local m=AdminModel:new()
assert_eq("admin",m._TABLE,"new() should set table name")
...
print("Test: create()")
local id=m:create({username="test_1770270714",phone="0714"})
