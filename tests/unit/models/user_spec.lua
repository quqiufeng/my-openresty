...
-- Generated by curd command. Run with: luajit tests/unit/models/user_spec.lua
...
local UserModel=require("app.models.UserModel")
...
print("=============================================================")
print("UserModel Unit Tests")
print("=============================================================")
print()

-- Test: new()
print("Test: new()")
local m=UserModel:new()
assert_eq("user",m._TABLE,"new() should set table name")
