...
-- Generated by curd command. Run with: luajit tests/unit/models/role_spec.lua
...
print("=============================================================")
print("RoleModel Unit Tests")
print("=============================================================")
print()

-- Test: new()
print("Test: new()")
local m=RoleModel:new()
assert_eq("role",m._TABLE,"new() should set table name")
...
print("Test: create()")
local id=m:create({username="test_1770271002",phone="1002"})
