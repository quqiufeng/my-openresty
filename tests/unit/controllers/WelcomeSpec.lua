-- Welcome Controller Unit Tests (Auto-generated)
-- Run with: luajit tests/unit/controllers/WelcomeSpec.lua
...
print("=============================================================")
print("Welcome Controller Unit Tests (Auto-generated)")
print("=============================================================")
print()

-- Test: controller file exists
print("Test: controller exists")
local ok, C = pcall(require, "app.controllers.welcome")
if not ok then
