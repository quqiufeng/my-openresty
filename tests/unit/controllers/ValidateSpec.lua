-- Validate Controller Unit Tests (Auto-generated)
-- Run with: luajit tests/unit/controllers/ValidateSpec.lua
...
print("=============================================================")
print("Validate Controller Unit Tests (Auto-generated)")
print("=============================================================")
print()

-- Test: controller file exists
print("Test: controller exists")
local ok, C = pcall(require, "app.controllers.validate")
if not ok then
