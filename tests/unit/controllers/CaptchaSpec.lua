-- Captcha Controller Unit Tests (Auto-generated)
-- Run with: luajit tests/unit/controllers/CaptchaSpec.lua
...
print("=============================================================")
print("Captcha Controller Unit Tests (Auto-generated)")
print("=============================================================")
print()

-- Test: controller file exists
print("Test: controller exists")
local ok, C = pcall(require, "app.controllers.captcha")
if not ok then
