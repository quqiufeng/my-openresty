-- Request_demo Controller Unit Tests (Auto-generated)
-- Run with: luajit tests/unit/controllers/Request_demoSpec.lua
...
print("=============================================================")
print("Request_demo Controller Unit Tests (Auto-generated)")
print("=============================================================")
print()

-- Test: controller file exists
print("Test: controller exists")
local ok, C = pcall(require, "app.controllers.request_demo")
if not ok then
