-- Cache Controller Unit Tests (Auto-generated)
-- Run with: luajit tests/unit/controllers/CacheSpec.lua
...
print("=============================================================")
print("Cache Controller Unit Tests (Auto-generated)")
print("=============================================================")
print()

-- Test: controller file exists
print("Test: controller exists")
local ok, C = pcall(require, "app.controllers.cache")
if not ok then
