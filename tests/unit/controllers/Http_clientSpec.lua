-- Http_client Controller Unit Tests (Auto-generated)
-- Run with: luajit tests/unit/controllers/Http_clientSpec.lua
...
print("=============================================================")
print("Http_client Controller Unit Tests (Auto-generated)")
print("=============================================================")
print()

-- Test: controller file exists
print("Test: controller exists")
local ok, C = pcall(require, "app.controllers.http_client")
if not ok then
