-- Middleware_demo Controller Unit Tests (Auto-generated)
-- Run with: luajit tests/unit/controllers/Middleware_demoSpec.lua
...
print("=============================================================")
print("Middleware_demo Controller Unit Tests (Auto-generated)")
print("=============================================================")
print()

-- Test: controller file exists
print("Test: controller exists")
local ok, C = pcall(require, "app.controllers.middleware_demo")
if not ok then
