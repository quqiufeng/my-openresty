-- Article Controller Unit Tests (Auto-generated)
-- Run with: luajit tests/unit/controllers/ArticleSpec.lua
...
print("=============================================================")
print("Article Controller Unit Tests (Auto-generated)")
print("=============================================================")
print()

-- Test: controller file exists
print("Test: controller exists")
local ok, C = pcall(require, "app.controllers.Article")
if not ok then
