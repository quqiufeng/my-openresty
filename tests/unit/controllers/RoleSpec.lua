-- Role Controller Unit Tests
-- Generated by curd command. Run with: luajit tests/unit/controllers/RoleSpec.lua
...
print("=============================================================")
print("Role Controller Unit Tests")
print("=============================================================")
print()

-- Test: controller should load model
print("Test: controller structure")
local C=require("app.controllers.Role")
